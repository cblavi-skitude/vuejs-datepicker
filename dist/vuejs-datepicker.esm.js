...
var script$1 = {
  ...
  methods: {
     ...
     * @return {Boolean}
     */
    isDisabledFull: function isDisabledFull(date) {
      var _this2 = this;
      ...
      if (typeof this.disabledCapacityDates.dates !== 'undefined') {
        this.disabledCapacityDates.dates.forEach(function (d) {
...
var __vue_render__$1 = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { class: _vm.isRtl ? "flex-rtl" : "", attrs: { id: "calendar-days" } },
        [
        ...
        ? _c(
            "picker-day",
            {
              attrs: {
                ...
                disabledCapacityDates: _vm.disabledCapacityDates,
                daysWithcustomClass: _vm.daysWithcustomClass,
